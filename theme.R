...
fnTheme <- function(legend.position = "bottom", baseTextSize = 8, x.text.angle = 0, vjustx = NULL, hjustx = NULL, vjusty = NULL, hjusty = NULL,
  ...
  custom_theme <- theme_pubr(legend = legend.position) +
    ...
    theme(
      ...
      axis.text.x = element_text(size = baseTextSize + 2, angle = x.text.angle, vjust = vjust, hjust = hjust, face = face.axisText),
      axis.text.y = element_text(size = baseTextSize + 2, angle = x.text.angle, vjust = vjusty, hjust = hjusty, face = face.axisText),
